...
export default function LanguageSelector() {    
    ...
    return (
        <div class="dropdown">
            <button class="btn dropdown-toggle d-flex align-items-center justify-content-center" 
                    type="button" 
                    id="languageDropdown" 
...
<li><span class="dropdown-item"><span class="fi fi-fi me-2"></span>Suomi</span></li> */}